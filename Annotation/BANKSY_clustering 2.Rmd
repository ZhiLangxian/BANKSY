...
input_spe_filename <- "calcinosis_8_sfe_QC_TRUE_dgc250714092435.rds"  # Specify the 'spe' file name
...
cell_type_anno <- c("all_level1") # Specify the cell types that are aimed to annotate
...
#spe_merged <- spe_merged[valid_genes, ] 
